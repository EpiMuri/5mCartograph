...
# python3 [script used] [partial DSP result file path] [partial repeat_annotation file path]
...
for idx, lineC in enumerate(linesC):
    ...
    if len(re.split('\t', lineC)) >= columns:
        ...
        # [11-20] : methylation distribution in CHH context
        # [21-30] : methylation distribution in CHG context

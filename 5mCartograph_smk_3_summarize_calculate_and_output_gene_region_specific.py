# VERSION: 06.11.2024
# 5mCartograph_smk_3_summarize_calculate_and_output_gene_region_specific.py -> summarizes data of subsets and calculates data of interest
# ooptimized to only use data from regions of interest (genes + 1 kb up- and downstream)
# the 5mer summary was adjusted -> non-genic data is excluded
# the chromosomes summary was not adjusted -> still includes data from non-genic regions
...
# create gene_region string for output 
file_out = sys.argv[1].rsplit('/', 2)[0]

# file path log output (also includes results)
fileLOG_3 = file_out + '/5mCartograph_out3/5mCartograph_out3_log_and_results_gene_region_specific.txt'
print(fileLOG_3)
...
for k_mer in all_5_mers:
    ...
    # calculate values of interest -> 5-mers and exons, introns in CG, CHH and CHG context
...
# calculate proportion of CDS, ... in CG, CHH and CHG context -> (1) + (2)
...
c_unmet_CDS = CG_unmet_CDS + CHH_unmet_CDS + CHG_unmet_CDS
c_unmet_UTR = CG_unmet_UTR + CHH_unmet_UTR + CHG_unmet_UTR
c_unmet_exon = c_unmet_CDS + c_unmet_UTR
c_unmet_intron = CG_unmet_intron + CHH_unmet_intron + CHG_unmet_intron
c_unmet_genic = c_unmet_exon + c_unmet_intron
c_unmet_non_genic = CG_unmet_non_genic + CHH_unmet_non_genic + CHG_unmet_non_genic
...
c_rather_unmet_CDS = CG_rather_unmet_CDS + CHH_rather_unmet_CDS + CHG_rather_unmet_CDS
c_rather_unmet_UTR = CG_rather_unmet_UTR + CHH_rather_unmet_UTR + CHG_rather_unmet_UTR
c_rather_unmet_exon = c_rather_unmet_CDS + c_rather_unmet_UTR
c_rather_unmet_intron = CG_rather_unmet_intron + CHH_rather_unmet_intron + CHG_rather_unmet_intron
c_rather_unmet_genic = c_rather_unmet_exon + c_rather_unmet_intron
c_rather_unmet_non_genic = CG_rather_unmet_non_genic + CHH_rather_unmet_non_genic + CHG_rather_unmet_non_genic
...
c_50met_CDS = CG_50met_CDS + CHH_50met_CDS + CHG_50met_CDS
c_50met_UTR = CG_50met_UTR + CHH_50met_UTR + CHG_50met_UTR
c_50met_exon = c_50met_CDS + c_50met_UTR
c_50met_intron = CG_50met_intron + CHH_50met_intron + CHG_50met_intron
c_50met_genic = c_50met_exon + c_50met_intron
c_50met_non_genic = CG_50met_non_genic + CHH_50met_non_genic + CHG_50met_non_genic
...
c_rather_met_CDS = CG_rather_met_CDS + CHH_rather_met_CDS + CHG_rather_met_CDS
c_rather_met_UTR = CG_rather_met_UTR + CHH_rather_met_UTR + CHG_rather_met_UTR
c_rather_met_exon = c_rather_met_CDS + c_rather_met_UTR
c_rather_met_intron = CG_rather_met_intron + CHH_rather_met_intron + CHG_rather_met_intron
c_rather_met_genic = c_rather_met_exon + c_rather_met_intron
c_rather_met_non_genic = CG_rather_met_non_genic + CHH_rather_met_non_genic + CHG_rather_met_non_genic
...
c_met_CDS = CG_met_CDS + CHH_met_CDS + CHG_met_CDS
c_met_UTR = CG_met_UTR + CHH_met_UTR + CHG_met_UTR
c_met_exon = c_met_CDS + c_met_UTR
c_met_intron = CG_met_intron + CHH_met_intron + CHG_met_intron
c_met_genic = c_met_exon + c_met_intron
c_met_non_genic = CG_met_non_genic + CHH_met_non_genic + CHG_met_non_genic
...
c_CDS = CG_CDS + CHH_CDS + CHG_CDS
c_UTR =  CG_UTR + CHH_UTR + CHG_UTR
c_exon = CG_exon + CHH_exon + CHG_exon
c_intron = CG_intron + CHH_intron + CHG_intron
c_genic = CG_genic + CHH_genic + CHG_genic
c_non_genic = CG_non_genic + CHH_non_genic + CHG_non_genic
...
with open(fileLOG_3, "w") as out3:
    ...
    out3.write('-> note 17.06.2024\n')
    out3.write('UTR: means all cytosines, that are in a CDS but not in an exon \n')
    out3.write('non genic: means all cytosines, that are not related to a gene (not in or within a 1000 bp zone around a gene) \n')
    out3.write('to calculate all cytosines that are not in a genes add all upstream and downstream Cs to non genic\n')
    out3.write('\n')
    ...
    out3.write('cytosines in CDSs: ' + str(round(c_CDS, 2)) + ' %\n')
    out3.write('unmethylated cytosines in CDSs: ' + str(round(c_unmet_CDS, 2)) + ' %\n')
    out3.write('rather unmethylated cytosines in CDSs: ' + str(round(c_rather_unmet_CDS, 2)) + ' %\n')
    out3.write('50/50-methylated cytosines in CDSs: ' + str(round(c_50met_CDS, 2)) + ' %\n')
    out3.write('rather methylated cytosines in CDSs: ' + str(round(c_rather_met_CDS, 2)) + ' %\n')
    out3.write('methylated cytosines in CDSs: ' + str(round(c_met_CDS, 2)) + ' %\n')
    out3.write('\n')
    out3.write('cytosines in UTRs: ' + str(round(c_UTR, 2)) + ' %\n')
    out3.write('unmethylated cytosines in UTRs: ' + str(round(c_unmet_UTR, 2)) + ' %\n')
    out3.write('rather unmethylated cytosines in UTRs: ' + str(round(c_rather_unmet_UTR, 2)) + ' %\n')
    out3.write('50/50-methylated cytosines in UTRs: ' + str(round(c_50met_UTR, 2)) + ' %\n')
    out3.write('rather methylated cytosines in UTRs: ' + str(round(c_rather_met_UTR, 2)) + ' %\n')
    out3.write('methylated cytosines in UTRs: ' + str(round(c_met_UTR, 2)) + ' %\n')
    out3.write('\n')
    out3.write('cytosines in exons: ' + str(round(c_exon, 2)) + ' %\n')
    out3.write('unmethylated cytosines in exons: ' + str(round(c_unmet_exon, 2)) + ' %\n')
    out3.write('rather unmethylated cytosines in exons: ' + str(round(c_rather_unmet_exon, 2)) + ' %\n')
    out3.write('50/50-methylated cytosines in exons: ' + str(round(c_50met_exon, 2)) + ' %\n')
    out3.write('rather methylated cytosines in exons: ' + str(round(c_rather_met_exon, 2)) + ' %\n')
    out3.write('methylated cytosines in exons: ' + str(round(c_met_exon, 2)) + ' %\n')
    out3.write('\n')
    out3.write('cytosines in introns: ' + str(round(c_intron, 2)) + ' %\n')
    out3.write('unmethylated cytosines in introns: ' + str(round(c_unmet_intron, 2)) + ' %\n')
    out3.write('rather unmethylated cytosines in introns: ' + str(round(c_rather_unmet_intron, 2)) + ' %\n')
    out3.write('50/50-methylated cytosines in introns: ' + str(round(c_50met_intron, 2)) + ' %\n')
    out3.write('rather methylated cytosines in introns: ' + str(round(c_rather_met_intron, 2)) + ' %\n')
    out3.write('methylated cytosines in introns: ' + str(round(c_met_intron, 2)) + ' %\n')
    out3.write('\n')
    out3.write('cytosines in genic regions: ' + str(round(c_genic, 2)) + ' %\n')
    out3.write('unmethylated cytosines in genic regions: ' + str(round(c_unmet_genic, 2)) + ' %\n')
    out3.write('rather unmethylated cytosines in genic regions: ' + str(round(c_rather_unmet_genic, 2)) + ' %\n')
    out3.write('50/50-methylated cytosines in genic regions: ' + str(round(c_50met_genic, 2)) + ' %\n')
    out3.write('rather methylated cytosines in genic regions: ' + str(round(c_rather_met_genic, 2)) + ' %\n')
    out3.write('methylated cytosines in genic regions: ' + str(round(c_met_genic, 2)) + ' %\n')
    out3.write('\n')
    out3.write('cytosines in 1kb upstream: ' + str(round(c_upstream, 2)) + ' %\n')
    out3.write('unmethylated cytosines in 1kb upstream: ' + str(round(c_unmet_upstream, 2)) + ' %\n')
    out3.write('rather unmethylated cytosines in 1kb upstream: ' + str(round(c_rather_unmet_upstream, 2)) + ' %\n')
    out3.write('50/50-methylated cytosines in 1kb upstream: ' + str(round(c_50met_upstream, 2)) + ' %\n')
    out3.write('rather methylated cytosines in 1kb upstream: ' + str(round(c_rather_met_upstream, 2)) + ' %\n')
    out3.write('methylated cytosines in 1kb upstream: ' + str(round(c_met_upstream, 2)) + ' %\n')
    out3.write('\n')
    out3.write('cytosines in 1kb downstream: ' + str(round(c_downstream, 2)) + ' %\n')
    out3.write('unmethylated cytosines in 1kb downstream: ' + str(round(c_unmet_downstream, 2)) + ' %\n')
    out3.write('rather unmethylated cytosines in 1kb downstream: ' + str(round(c_rather_unmet_downstream, 2)) + ' %\n')
    out3.write('50/50-methylated cytosines in 1kb downstream: ' + str(round(c_50met_downstream, 2)) + ' %\n')
    out3.write('rather methylated cytosines in 1kb downstream: ' + str(round(c_rather_met_downstream, 2)) + ' %\n')
    out3.write('methylated cytosines in 1kb downstream: ' + str(round(c_met_downstream, 2)) + ' %\n')
    out3.write('\n')
    out3.write('cytosines in non genic regions: ' + str(round(c_non_genic, 2)) + ' %\n')
    out3.write('unmethylated cytosines in non genic regions: ' + str(round(c_unmet_non_genic, 2)) + ' %\n')
    out3.write('rather unmethylated cytosines in non genic regions: ' + str(round(c_rather_unmet_non_genic, 2)) + ' %\n')
    out3.write('50/50-methylated cytosines in non genic regions: ' + str(round(c_50met_non_genic, 2)) + ' %\n')
    out3.write('rather methylated cytosines in non genic regions: ' + str(round(c_rather_met_non_genic, 2)) + ' %\n')
    out3.write('methylated cytosines in non genic regions: ' + str(round(c_met_non_genic, 2)) + ' %\n')
    out3.write('\n')
    ...
    out3.write('\n')
    out3.write('CGs in CDSs: ' + str(round(CG_100_CDS, 2)) + ' %\n')
    out3.write('unmethylated CGs in CDSs: ' + str(round(CG_100_unmet_CDS, 2)) + ' %\n')
    out3.write('rather unmethylated CGs in CDSs: ' + str(round(CG_100_rather_unmet_CDS, 2)) + ' %\n')
    out3.write('50/50-methylated CGs in CDSs: ' + str(round(CG_100_50met_CDS, 2)) + ' %\n')
    out3.write('rather methylated CGs in CDSs: ' + str(round(CG_100_rather_met_CDS, 2)) + ' %\n')
    out3.write('methylated CGs in CDSs: ' + str(round(CG_100_met_CDS, 2)) + ' %\n')
    out3.write('\n')
    out3.write('CGs in UTRs: ' + str(round(CG_100_UTR, 2)) + ' %\n')
    out3.write('unmethylated CGs in UTRs: ' + str(round(CG_100_unmet_UTR, 2)) + ' %\n')
    out3.write('rather unmethylated CGs in UTRs: ' + str(round(CG_100_rather_unmet_UTR, 2)) + ' %\n')
    out3.write('50/50-methylated CGs in UTRs: ' + str(round(CG_100_50met_UTR, 2)) + ' %\n')
    out3.write('rather methylated CGs in UTRs: ' + str(round(CG_100_rather_met_UTR, 2)) + ' %\n')
    out3.write('methylated CGs in UTRs: ' + str(round(CG_100_met_UTR, 2)) + ' %\n')
    out3.write('\n')
    out3.write('CGs in exons: ' + str(round(CG_100_exon, 2)) + ' %\n')
    out3.write('unmethylated CGs in exons: ' + str(round(CG_100_unmet_exon, 2)) + ' %\n')
    out3.write('rather unmethylated CGs in exons: ' + str(round(CG_100_rather_unmet_exon, 2)) + ' %\n')
    out3.write('50/50-methylated CGs in exons: ' + str(round(CG_100_50met_exon, 2)) + ' %\n')
    out3.write('rather methylated CGs in exons: ' + str(round(CG_100_rather_met_exon, 2)) + ' %\n')
    out3.write('methylated CGs in exons: ' + str(round(CG_100_met_exon, 2)) + ' %\n')
    out3.write('\n')
    out3.write('CGs in introns: ' + str(round(CG_100_intron, 2)) + ' %\n')
    out3.write('unmethylated CGs in introns: ' + str(round(CG_100_unmet_intron, 2)) + ' %\n')
    out3.write('rather unmethylated CGs in introns: ' + str(round(CG_100_rather_unmet_intron, 2)) + ' %\n')
    out3.write('50/50-methylated CGs in introns: ' + str(round(CG_100_50met_intron, 2)) + ' %\n')
    out3.write('rather methylated CGs in introns: ' + str(round(CG_100_rather_met_intron, 2)) + ' %\n')
    out3.write('methylated CGs in introns: ' + str(round(CG_100_met_intron, 2)) + ' %\n')
    out3.write('\n')
    out3.write('CGs in genic regions: ' + str(round(CG_100_genic, 2)) + ' %\n')
    out3.write('unmethylated CGs in genic regions: ' + str(round(CG_100_unmet_genic, 2)) + ' %\n')
    out3.write('rather unmethylated CGs in genic regions: ' + str(round(CG_100_rather_unmet_genic, 2)) + ' %\n')
    out3.write('50/50-methylated CGs in genic regions: ' + str(round(CG_100_50met_genic, 2)) + ' %\n')
    out3.write('rather methylated CGs in genic regions: ' + str(round(CG_100_rather_met_genic, 2)) + ' %\n')
    out3.write('methylated CGs in genic regions: ' + str(round(CG_100_met_genic, 2)) + ' %\n')
    out3.write('\n')
    out3.write('CGs in 1kb upstream: ' + str(round(CG_100_upstream, 2)) + ' %\n')
    out3.write('unmethylated CGs in 1kb upstream: ' + str(round(CG_100_unmet_upstream, 2)) + ' %\n')
    out3.write('rather unmethylated CGs in 1kb upstream: ' + str(round(CG_100_rather_unmet_upstream, 2)) + ' %\n')
    out3.write('50/50-methylated CGs in 1kb upstream: ' + str(round(CG_100_50met_upstream, 2)) + ' %\n')
    out3.write('rather methylated CGs in 1kb upstream: ' + str(round(CG_100_rather_met_upstream, 2)) + ' %\n')
    out3.write('methylated CGs in 1kb upstream: ' + str(round(CG_100_met_upstream, 2)) + ' %\n')
    out3.write('\n')
    out3.write('CGs in 1kb downstream: ' + str(round(CG_100_downstream, 2)) + ' %\n')
    out3.write('unmethylated CGs in 1kb downstream: ' + str(round(CG_100_unmet_downstream, 2)) + ' %\n')
    out3.write('rather unmethylated CGs in 1kb downstream: ' + str(round(CG_100_rather_unmet_downstream, 2)) + ' %\n')
    out3.write('50/50-methylated CGs in 1kb downstream: ' + str(round(CG_100_50met_downstream, 2)) + ' %\n')
    out3.write('rather methylated CGs in 1kb downstream: ' + str(round(CG_100_rather_met_downstream, 2)) + ' %\n')
    out3.write('methylated CGs in 1kb downstream: ' + str(round(CG_100_met_downstream, 2)) + ' %\n')
    out3.write('\n')
    out3.write('CGs in non genic regions: ' + str(round(CG_100_non_genic, 2)) + ' %\n')
    out3.write('unmethylated CGs in non genic regions: ' + str(round(CG_100_unmet_non_genic, 2)) + ' %\n')
    out3.write('rather unmethylated CGs in non genic regions: ' + str(round(CG_100_rather_unmet_non_genic, 2)) + ' %\n')
    out3.write('50/50-methylated CGs in non genic regions: ' + str(round(CG_100_50met_non_genic, 2)) + ' %\n')
    out3.write('rather methylated CGs in non genic regions: ' + str(round(CG_100_rather_met_non_genic, 2)) + ' %\n')
    out3.write('methylated CGs in non genic regions: ' + str(round(CG_100_met_non_genic, 2)) + ' %\n')
    out3.write('\n')
    ...
    out3.write('\n')
    out3.write('CHHs in CDSs: ' + str(round(CHH_100_CDS, 2)) + ' %\n')
    out3.write('unmethylated CHHs in CDSs: ' + str(round(CHH_100_unmet_CDS, 2)) + ' %\n')
    out3.write('rather unmethylated CHHs in CDSs: ' + str(round(CHH_100_rather_unmet_CDS, 2)) + ' %\n')
    out3.write('50/50-methylated CHHs in CDSs: ' + str(round(CHH_100_50met_CDS, 2)) + ' %\n')
    out3.write('rather methylated CHHs in CDSs: ' + str(round(CHH_100_rather_met_CDS, 2)) + ' %\n')
    out3.write('methylated CHHs in CDSs: ' + str(round(CHH_100_met_CDS, 2)) + ' %\n')
    out3.write('\n')
    out3.write('CHHs in UTRs: ' + str(round(CHH_100_UTR, 2)) + ' %\n')
    out3.write('unmethylated CHHs in UTRs: ' + str(round(CHH_100_unmet_UTR, 2)) + ' %\n')
    out3.write('rather unmethylated CHHs in UTRs: ' + str(round(CHH_100_rather_unmet_UTR, 2)) + ' %\n')
    out3.write('50/50-methylated CHHs in UTRs: ' + str(round(CHH_100_50met_UTR, 2)) + ' %\n')
    out3.write('rather methylated CHHs in UTRs: ' + str(round(CHH_100_rather_met_UTR, 2)) + ' %\n')
    out3.write('methylated CHHs in UTRs: ' + str(round(CHH_100_met_UTR, 2)) + ' %\n')
    out3.write('\n')
    out3.write('CHHs in exons: ' + str(round(CHH_100_exon, 2)) + ' %\n')
    out3.write('unmethylated CHHs in exons: ' + str(round(CHH_100_unmet_exon, 2)) + ' %\n')
    out3.write('rather unmethylated CHHs in exons: ' + str(round(CHH_100_rather_unmet_exon, 2)) + ' %\n')
    out3.write('50/50-methylated CHHs in exons: ' + str(round(CHH_100_50met_exon, 2)) + ' %\n')
    out3.write('rather methylated CHHs in exons: ' + str(round(CHH_100_rather_met_exon, 2)) + ' %\n')
    out3.write('methylated CHHs in exons: ' + str(round(CHH_100_met_exon, 2)) + ' %\n')
    out3.write('\n')
    out3.write('CHHs in introns: ' + str(round(CHH_100_intron, 2)) + ' %\n')
    out3.write('unmethylated CHHs in introns: ' + str(round(CHH_100_unmet_intron, 2)) + ' %\n')
    out3.write('rather unmethylated CHHs in introns: ' + str(round(CHH_100_rather_unmet_intron, 2)) + ' %\n')
    out3.write('50/50-methylated CHHs in introns: ' + str(round(CHH_100_50met_intron, 2)) + ' %\n')
    out3.write('rather methylated CHHs in introns: ' + str(round(CHH_100_rather_met_intron, 2)) + ' %\n')
    out3.write('methylated CHHs in introns: ' + str(round(CHH_100_met_intron, 2)) + ' %\n')
    out3.write('\n')
    out3.write('CHHs in genic regions: ' + str(round(CHH_100_genic, 2)) + ' %\n')
    out3.write('unmethylated CHHs in genic regions: ' + str(round(CHH_100_unmet_genic, 2)) + ' %\n')
    out3.write('rather unmethylated CHHs in genic regions: ' + str(round(CHH_100_rather_unmet_genic, 2)) + ' %\n')
    out3.write('50/50-methylated CHHs in genic regions: ' + str(round(CHH_100_50met_genic, 2)) + ' %\n')
    out3.write('rather methylated CHHs in genic regions: ' + str(round(CHH_100_rather_met_genic, 2)) + ' %\n')
    out3.write('methylated CHHs in genic regions: ' + str(round(CHH_100_met_genic, 2)) + ' %\n')
    out3.write('\n')
    out3.write('CHHs in 1kb upstream: ' + str(round(CHH_100_upstream, 2)) + ' %\n')
    out3.write('unmethylated CHHs in 1kb upstream: ' + str(round(CHH_100_unmet_upstream, 2)) + ' %\n')
    out3.write('rather unmethylated CHHs in 1kb upstream: ' + str(round(CHH_100_rather_unmet_upstream, 2)) + ' %\n')
    out3.write('50/50-methylated CHHs in 1kb upstream: ' + str(round(CHH_100_50met_upstream, 2)) + ' %\n')
    out3.write('rather methylated CHHs in 1kb upstream: ' + str(round(CHH_100_rather_met_upstream, 2)) + ' %\n')
    out3.write('methylated CHHs in 1kb upstream: ' + str(round(CHH_100_met_upstream, 2)) + ' %\n')
    out3.write('\n')
    out3.write('CHHs in 1kb downstream: ' + str(round(CHH_100_downstream, 2)) + ' %\n')
    out3.write('unmethylated CHHs in 1kb downstream: ' + str(round(CHH_100_unmet_downstream, 2)) + ' %\n')
    out3.write('rather unmethylated CHHs in 1kb downstream: ' + str(round(CHH_100_rather_unmet_downstream, 2)) + ' %\n')
    out3.write('50/50-methylated CHHs in 1kb downstream: ' + str(round(CHH_100_50met_downstream, 2)) + ' %\n')
    out3.write('rather methylated CHHs in 1kb downstream: ' + str(round(CHH_100_rather_met_downstream, 2)) + ' %\n')
    out3.write('methylated CHHs in 1kb downstream: ' + str(round(CHH_100_met_downstream, 2)) + ' %\n')
    out3.write('\n')
    out3.write('CHHs in non genic regions: ' + str(round(CHH_100_non_genic, 2)) + ' %\n')
    out3.write('unmethylated CHHs in non genic regions: ' + str(round(CHH_100_unmet_non_genic, 2)) + ' %\n')
    out3.write('rather unmethylated CHHs in non genic regions: ' + str(round(CHH_100_rather_unmet_non_genic, 2)) + ' %\n')
    out3.write('50/50-methylated CHHs in non genic regions: ' + str(round(CHH_100_50met_non_genic, 2)) + ' %\n')
    out3.write('rather methylated CHHs in non genic regions: ' + str(round(CHH_100_rather_met_non_genic, 2)) + ' %\n')
    out3.write('methylated CHHs in non genic regions: ' + str(round(CHH_100_met_non_genic, 2)) + ' %\n')
    out3.write('\n')
    ...
    out3.write('\n')
    out3.write('CHGs in CDSs: ' + str(round(CHG_100_CDS, 2)) + ' %\n')
    out3.write('unmethylated CHGs in CDSs: ' + str(round(CHG_100_unmet_CDS, 2)) + ' %\n')
    out3.write('rather unmethylated CHGs in CDSs: ' + str(round(CHG_100_rather_unmet_CDS, 2)) + ' %\n')
    out3.write('50/50-methylated CHGs in CDSs: ' + str(round(CHG_100_50met_CDS, 2)) + ' %\n')
    out3.write('rather methylated CHGs in CDSs: ' + str(round(CHG_100_rather_met_CDS, 2)) + ' %\n')
    out3.write('methylated CHGs in CDSs: ' + str(round(CHG_100_met_CDS, 2)) + ' %\n')
    out3.write('\n')
    out3.write('CHGs in UTRs: ' + str(round(CHG_100_UTR, 2)) + ' %\n')
    out3.write('unmethylated CHGs in UTRs: ' + str(round(CHG_100_unmet_UTR, 2)) + ' %\n')
    out3.write('rather unmethylated CHGs in UTRs: ' + str(round(CHG_100_rather_unmet_UTR, 2)) + ' %\n')
    out3.write('50/50-methylated CHGs in UTRs: ' + str(round(CHG_100_50met_UTR, 2)) + ' %\n')
    out3.write('rather methylated CHGs in UTRs: ' + str(round(CHG_100_rather_met_UTR, 2)) + ' %\n')
    out3.write('methylated CHGs in UTRs: ' + str(round(CHG_100_met_UTR, 2)) + ' %\n')
    out3.write('\n')
    out3.write('CHGs in exons: ' + str(round(CHG_100_exon, 2)) + ' %\n')
    out3.write('unmethylated CHGs in exons: ' + str(round(CHG_100_unmet_exon, 2)) + ' %\n')
    out3.write('rather unmethylated CHGs in exons: ' + str(round(CHG_100_rather_unmet_exon, 2)) + ' %\n')
    out3.write('50/50-methylated CHGs in exons: ' + str(round(CHG_100_50met_exon, 2)) + ' %\n')
    out3.write('rather methylated CHGs in exons: ' + str(round(CHG_100_rather_met_exon, 2)) + ' %\n')
    out3.write('methylated CHGs in exons: ' + str(round(CHG_100_met_exon, 2)) + ' %\n')
    out3.write('\n')
    out3.write('CHGs in introns: ' + str(round(CHG_100_intron, 2)) + ' %\n')
    out3.write('unmethylated CHGs in introns: ' + str(round(CHG_100_unmet_intron, 2)) + ' %\n')
    out3.write('rather unmethylated CHGs in introns: ' + str(round(CHG_100_rather_unmet_intron, 2)) + ' %\n')
    out3.write('50/50-methylated CHGs in introns: ' + str(round(CHG_100_50met_intron, 2)) + ' %\n')
    out3.write('rather methylated CHGs in introns: ' + str(round(CHG_100_rather_met_intron, 2)) + ' %\n')
    out3.write('methylated CHGs in introns: ' + str(round(CHG_100_met_intron, 2)) + ' %\n')
    out3.write('\n')
    out3.write('CHGs in genic regions: ' + str(round(CHG_100_genic, 2)) + ' %\n')
    out3.write('unmethylated CHGs in genic regions: ' + str(round(CHG_100_unmet_genic, 2)) + ' %\n')
    out3.write('rather unmethylated CHGs in genic regions: ' + str(round(CHG_100_rather_unmet_genic, 2)) + ' %\n')
    out3.write('50/50-methylated CHGs in genic regions: ' + str(round(CHG_100_50met_genic, 2)) + ' %\n')
    out3.write('rather methylated CHGs in genic regions: ' + str(round(CHG_100_rather_met_genic, 2)) + ' %\n')
    out3.write('methylated CHGs in genic regions: ' + str(round(CHG_100_met_genic, 2)) + ' %\n')
    out3.write('\n')
    out3.write('CHGs in 1kb upstream: ' + str(round(CHG_100_upstream, 2)) + ' %\n')
    out3.write('unmethylated CHGs in 1kb upstream: ' + str(round(CHG_100_unmet_upstream, 2)) + ' %\n')
    out3.write('rather unmethylated CHGs in 1kb upstream: ' + str(round(CHG_100_rather_unmet_upstream, 2)) + ' %\n')
    out3.write('50/50-methylated CHGs in 1kb upstream: ' + str(round(CHG_100_50met_upstream, 2)) + ' %\n')
    out3.write('rather methylated CHGs in 1kb upstream: ' + str(round(CHG_100_rather_met_upstream, 2)) + ' %\n')
    out3.write('methylated CHGs in 1kb upstream: ' + str(round(CHG_100_met_upstream, 2)) + ' %\n')
    out3.write('\n')
    out3.write('CHGs in 1kb downstream: ' + str(round(CHG_100_downstream, 2)) + ' %\n')
    out3.write('unmethylated CHGs in 1kb downstream: ' + str(round(CHG_100_unmet_downstream, 2)) + ' %\n')
    out3.write('rather unmethylated CHGs in 1kb downstream: ' + str(round(CHG_100_rather_unmet_downstream, 2)) + ' %\n')
    out3.write('50/50-methylated CHGs in 1kb downstream: ' + str(round(CHG_100_50met_downstream, 2)) + ' %\n')
    out3.write('rather methylated CHGs in 1kb downstream: ' + str(round(CHG_100_rather_met_downstream, 2)) + ' %\n')
    out3.write('methylated CHGs in 1kb downstream: ' + str(round(CHG_100_met_downstream, 2)) + ' %\n')
    out3.write('\n')
    out3.write('CHGs in non genic regions: ' + str(round(CHG_100_non_genic, 2)) + ' %\n')
    out3.write('unmethylated CHGs in non genic regions: ' + str(round(CHG_100_unmet_non_genic, 2)) + ' %\n')
    out3.write('rather unmethylated CHGs in non genic regions: ' + str(round(CHG_100_rather_unmet_non_genic, 2)) + ' %\n')
    out3.write('50/50-methylated CHGs in non genic regions: ' + str(round(CHG_100_50met_non_genic, 2)) + ' %\n')
    out3.write('rather methylated CHGs in non genic regions: ' + str(round(CHG_100_rather_met_non_genic, 2)) + ' %\n')
    out3.write('methylated CHGs in non genic regions: ' + str(round(CHG_100_met_non_genic, 2)) + ' %\n')
    out3.write('\n')
    
    out3.write('------------------------------------------------------------------------------\n')
    out3.write('\n')

    out3.write('[number_unmethylated, %_unmethylated, ..., number_methylated, %_methylated] in CDS, UTRs, introns, 1kb upstream, 1kb downstream and non_genic regions\n')
    for entry in all_5_mers:
        ...
        out3.write(str(entry[41:51]) + '\n')
        out3.write(str(entry[51:]) + '\n')

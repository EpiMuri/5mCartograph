...
fileLOG_3_1 = file_out + '/5mCartograph_out3/5mCartograph_out3_log_and_results_gene_region_specific.txt'
fileLOG_3_2 = file_out + '/5mCartograph_out3/5mCartograph_out3_5mer_results_gene_region_specific.txt'
fileLOG_3_3 = file_out + '/5mCartograph_out3/5mCartograph_out3_chromosome_contig_results_gene_region_specific.txt'
print(fileLOG_3_1)
print(fileLOG_3_2)
print(fileLOG_3_3)

...
# this script is designed for the plotting of all genes methylation rates
...
# log file
log_file = folder + '/5mCartograph_plot_results_grouped_all_genes_gry_log.txt'
...
with open(log_file, 'w') as fileOut:
    ...
    fileOut.write('5mCartograph - all genes 5mC, CG, CHG and CHH methylation probability distribution figure (grouped)\n')
...
# alternative y axis if values are high -> legend 
ax.set_ylim(top=120)
# ax.set_ylim(top=159)
...
plt.savefig(folder+'/5mCartograph_plot_results_grouped_all_genes_gry.png', bbox_inches='tight')
plt.show()

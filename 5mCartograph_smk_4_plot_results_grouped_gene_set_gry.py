...
def get_data_of_interest(lines):
    ...
    for idx, line in enumerate(lines):
        ...
        elif line.startswith('unmethylated cytosines in genic regions: ', 0):
        ...
        elif line.startswith('methylated cytosines in genic regions: ', 0):
            values[4] = float(line.split(' ')[-2])
        # CG
        elif line.startswith('CGs in genic regions: ', 0):
            CG_p = float(line.split(' ')[-2])
        elif line.startswith('unmethylated CGs in genic regions: ', 0):
        ...
        elif line.startswith('methylated CGs in genic regions: ', 0):
            values[9] = float(line.split(' ')[-2])
        # CHG
        elif line.startswith('CHGs in genic regions: ', 0):
            CHG_p = float(line.split(' ')[-2])
        elif line.startswith('unmethylated CHGs in genic regions: ', 0):
        ...
        elif line.startswith('methylated CHGs in genic regions: ', 0):
            values[14] = float(line.split(' ')[-2])    
        # CHH
        elif line.startswith('CHHs in genic regions: ', 0):
            CHH_p = float(line.split(' ')[-2])
        elif line.startswith('unmethylated CHHs in genic regions: ', 0):
        ...
        elif line.startswith('methylated CHHs in genic regions: ', 0):
...
plt.savefig(folder+'/5mCartograph_plot_results_grouped_gene_set_gry_profile_in_title.png', bbox_inches='tight')
plt.show()

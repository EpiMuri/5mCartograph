...
def get_data_of_interest(lines):
    ...
    for idx, line in enumerate(lines):
        # all Cs
        C_p = 100
        if line.startswith('unmethylated cytosines: ', 0):
        ...
        elif line.startswith('methylated cytosines: ', 0):
            values[4] = float(line.split(' ')[-2])
        # CG
        elif line.startswith('CGs: ', 0):
            CG_p = float(line.split(' ')[-2])
        elif line.startswith('unmethylated CGs: ', 0):
        ...
        elif line.startswith('methylated CHHs: ', 0):

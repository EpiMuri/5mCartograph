...
# Command: snakemake all --cores 10 -s 5mCartograph_gene_region_specific.smk
...
rule plot:
    ...
    output:
        png = "{folder}5mCartograph_out3/5mCartograph_plot_results_gene_region_specific.png",
        log = "{folder}5mCartograph_out3/5mCartograph_plot_results_log_gene_region_specific.txt"
    params:
        title = expand("{title}", title=plot_title)
    shell:
        """
        python3 /path/to/5mCartograph/5mCartograph_smk_4_plot_results_gene_region_specific.py {input.plot_data} {params.title} 
        """
...
rule all:
    input:
        ...
        result_all = expand("{folder}5mCartograph_out3/5mCartograph_out3_log_and_results_gene_region_specific.txt", folder=folder_name),
        png = expand("{folder}5mCartograph_out3/5mCartograph_plot_results_gene_region_specific.png", folder=folder_name),
        log = expand("{folder}5mCartograph_out3/5mCartograph_plot_results_log_gene_region_specific.txt", folder=folder_name)

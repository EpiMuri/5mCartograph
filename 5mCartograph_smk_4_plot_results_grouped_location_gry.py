...
def get_data_of_interest(lines, feature):
    ...
    for idx, line in enumerate(lines):
        ...
        elif line.startswith('unmethylated cytosines in ' + feature + ': ', 0):
        ...
        elif line.startswith('methylated cytosines in ' + feature + ': ', 0):
            values[4] = float(line.split(' ')[-2])
        # CG in location
        elif line.startswith('CGs in ' + feature + ': ', 0):
            CG_p = float(line.split(' ')[-2])
        elif line.startswith('unmethylated CGs in ' + feature + ': ', 0):
        ...
        elif line.startswith('methylated CGs in ' + feature + ': ', 0):
            values[9] = float(line.split(' ')[-2])
        # CHG in location
        elif line.startswith('CHGs in ' + feature + ': ', 0):
            CHG_p = float(line.split(' ')[-2])
        elif line.startswith('unmethylated CHGs in ' + feature + ': ', 0):
        ...
        elif line.startswith('methylated CHGs in ' + feature + ': ', 0):
            values[14] = float(line.split(' ')[-2])    
        # CHH in location
        elif line.startswith('CHHs in ' + feature + ': ', 0):
            CHH_p = float(line.split(' ')[-2])
        elif line.startswith('unmethylated CHHs in ' + feature + ': ', 0):
        ...
        elif line.startswith('methylated CHHs in ' + feature + ': ', 0):

...
# inputs
input_number = len(sys.argv)-3
index_for_split = int(input_number/2+1)
fileCounts5mer_list = sys.argv[1:index_for_split]
fileCountsChr_list = sys.argv[index_for_split:len(sys.argv)-2]

# create location string for output 
file_out = sys.argv[-2] + sys.argv[-1]

# file path log output (also includes results)
fileLOG_3_1 = file_out + '5mCartograph_REPEATS_out3/5mCartograph_REPEATS_smk_out3_log_and_results.txt'
fileLOG_3_2 = file_out + '5mCartograph_REPEATS_out3/5mCartograph_REPEATS_smk_out3_5mer_results.txt'
fileLOG_3_3 = file_out + '5mCartograph_REPEATS_out3/5mCartograph_REPEATS_smk_out3_chromosome_contig_results.txt'
print(fileLOG_3_1)
print(fileLOG_3_2)
print(fileLOG_3_3)
...
os.makedirs(file_out + '5mCartograph_REPEATS_out3/', exist_ok=True)
...
for k_mer in all_5_mers:
    ...
    # calculate values of interest -> 5-mers and exons, downstreams in CG, CHG and CHH context
...
# calculate proportion of ... in CG, CHG and CHH context -> (1) + (2)
...
c_unmet_repeat = CG_unmet_repeat + CHG_unmet_repeat + CHH_unmet_repeat
...
c_unmet_non_repeat = CG_unmet_non_repeat + CHG_unmet_non_repeat + CHH_unmet_non_repeat
c_rather_unmet_repeat = CG_rather_unmet_repeat + CHG_rather_unmet_repeat + CHH_rather_unmet_repeat
...
c_rather_unmet_non_repeat = CG_rather_unmet_non_repeat + CHG_rather_unmet_non_repeat + CHH_rather_unmet_non_repeat
c_50met_repeat = CG_50met_repeat + CHG_50met_repeat + CHH_50met_repeat
...
c_50met_non_repeat = CG_50met_non_repeat + CHG_50met_non_repeat + CHH_50met_non_repeat
c_rather_met_repeat = CG_rather_met_repeat + CHG_rather_met_repeat + CHH_rather_met_repeat
...
c_rather_met_non_repeat = CG_rather_met_non_repeat + CHG_rather_met_non_repeat + CHH_rather_met_non_repeat
c_met_repeat = CG_met_repeat + CHG_met_repeat + CHH_met_repeat
...
c_met_non_repeat = CG_met_non_repeat + CHG_met_non_repeat + CHH_met_non_repeat
...
with open(fileLOG_3_1, "w") as out3_1:
    ...
    out3_1.write('-> note 15.12.2024\n')
    out3_1.write('non repeat: means all cytosines, that are not related to a repeat (not in or within a 1000 bp zone around a repeat) \n')
    out3_1.write('to calculate all cytosines that are not in a repeat add all upstream and downstream Cs to non repeat\n')
    out3_1.write('\n')
    ...
    out3_1.write('cytosines in repeats: ' + str(round(c_repeat, 2)) + ' %\n')
    out3_1.write('highly unmethylated cytosines in repeats: ' + str(round(c_unmet_repeat, 2)) + ' %\n')
    out3_1.write('rather unmethylated cytosines in repeats: ' + str(round(c_rather_unmet_repeat, 2)) + ' %\n')
    out3_1.write('50/50-methylated cytosines in repeats: ' + str(round(c_50met_repeat, 2)) + ' %\n')
    out3_1.write('rather methylated cytosines in repeats: ' + str(round(c_rather_met_repeat, 2)) + ' %\n')
    out3_1.write('highly methylated cytosines in repeats: ' + str(round(c_met_repeat, 2)) + ' %\n')
    out3_1.write('\n')
    out3_1.write('cytosines in upstream: ' + str(round(c_upstream, 2)) + ' %\n')
    out3_1.write('highly unmethylated cytosines in upstream: ' + str(round(c_unmet_upstream, 2)) + ' %\n')
    out3_1.write('rather unmethylated cytosines in upstreams: ' + str(round(c_rather_unmet_upstream, 2)) + ' %\n')
    out3_1.write('50/50-methylated cytosines in upstream: ' + str(round(c_50met_upstream, 2)) + ' %\n')
    out3_1.write('rather methylated cytosines in upstream: ' + str(round(c_rather_met_upstream, 2)) + ' %\n')
    out3_1.write('highly methylated cytosines in upstream: ' + str(round(c_met_upstream, 2)) + ' %\n')
    out3_1.write('\n')
    out3_1.write('cytosines in downstream: ' + str(round(c_downstream, 2)) + ' %\n')
    out3_1.write('highly unmethylated cytosines in downstream: ' + str(round(c_unmet_downstream, 2)) + ' %\n')
    out3_1.write('rather unmethylated cytosines in downstream: ' + str(round(c_rather_unmet_downstream, 2)) + ' %\n')
    out3_1.write('50/50-methylated cytosines in downstream: ' + str(round(c_50met_downstream, 2)) + ' %\n')
    out3_1.write('rather methylated cytosines in downstream: ' + str(round(c_rather_met_downstream, 2)) + ' %\n')
    out3_1.write('highly methylated cytosines in downstream: ' + str(round(c_met_downstream, 2)) + ' %\n')
    out3_1.write('\n')
    out3_1.write('cytosines in non repeat regions: ' + str(round(c_non_repeat, 2)) + ' %\n')
    out3_1.write('highly unmethylated cytosines in non repeat regions: ' + str(round(c_unmet_non_repeat, 2)) + ' %\n')
    out3_1.write('rather unmethylated cytosines in non repeat regions: ' + str(round(c_rather_unmet_non_repeat, 2)) + ' %\n')
    out3_1.write('50/50-methylated cytosines in non repeat regions: ' + str(round(c_50met_non_repeat, 2)) + ' %\n')
    out3_1.write('rather methylated cytosines in non repeat regions: ' + str(round(c_rather_met_non_repeat, 2)) + ' %\n')
    out3_1.write('highly methylated cytosines in non repeat regions: ' + str(round(c_met_non_repeat, 2)) + ' %\n')
    out3_1.write('\n')
    ...
    out3_1.write('\n')
    out3_1.write('CGs in repeats: ' + str(round(CG_100_repeat, 2)) + ' %\n')
    out3_1.write('highly unmethylated CGs in repeats: ' + str(round(CG_100_unmet_repeat, 2)) + ' %\n')
    out3_1.write('rather unmethylated CGs in repeats: ' + str(round(CG_100_rather_unmet_repeat, 2)) + ' %\n')
    out3_1.write('50/50-methylated CGs in repeats: ' + str(round(CG_100_50met_repeat, 2)) + ' %\n')
    out3_1.write('rather methylated CGs in repeats: ' + str(round(CG_100_rather_met_repeat, 2)) + ' %\n')
    out3_1.write('highly methylated CGs in repeats: ' + str(round(CG_100_met_repeat, 2)) + ' %\n')
    out3_1.write('\n')
    out3_1.write('CGs in upstream: ' + str(round(CG_100_upstream, 2)) + ' %\n')
    out3_1.write('highly unmethylated CGs in upstream: ' + str(round(CG_100_unmet_upstream, 2)) + ' %\n')
    out3_1.write('rather unmethylated CGs in upstream: ' + str(round(CG_100_rather_unmet_upstream, 2)) + ' %\n')
    out3_1.write('50/50-methylated CGs in upstream: ' + str(round(CG_100_50met_upstream, 2)) + ' %\n')
    out3_1.write('rather methylated CGs in upstream: ' + str(round(CG_100_rather_met_upstream, 2)) + ' %\n')
    out3_1.write('highly methylated CGs in upstream: ' + str(round(CG_100_met_upstream, 2)) + ' %\n')
    out3_1.write('\n')
    out3_1.write('CGs in downstream: ' + str(round(CG_100_downstream, 2)) + ' %\n')
    out3_1.write('highly unmethylated CGs in downstream: ' + str(round(CG_100_unmet_downstream, 2)) + ' %\n')
    out3_1.write('rather unmethylated CGs in downstream: ' + str(round(CG_100_rather_unmet_downstream, 2)) + ' %\n')
    out3_1.write('50/50-methylated CGs in downstream: ' + str(round(CG_100_50met_downstream, 2)) + ' %\n')
    out3_1.write('rather methylated CGs in downstream: ' + str(round(CG_100_rather_met_downstream, 2)) + ' %\n')
    out3_1.write('highly methylated CGs in downstream: ' + str(round(CG_100_met_downstream, 2)) + ' %\n')
    out3_1.write('\n')
    out3_1.write('CGs in non repeat regions: ' + str(round(CG_100_non_repeat, 2)) + ' %\n')
    out3_1.write('highly unmethylated CGs in non repeat regions: ' + str(round(CG_100_unmet_non_repeat, 2)) + ' %\n')
    out3_1.write('rather unmethylated CGs in non repeat regions: ' + str(round(CG_100_rather_unmet_non_repeat, 2)) + ' %\n')
    out3_1.write('50/50-methylated CGs in non repeat regions: ' + str(round(CG_100_50met_non_repeat, 2)) + ' %\n')
    out3_1.write('rather methylated CGs in non repeat regions: ' + str(round(CG_100_rather_met_non_repeat, 2)) + ' %\n')
    out3_1.write('highly methylated CGs in non repeat regions: ' + str(round(CG_100_met_non_repeat, 2)) + ' %\n')
    out3_1.write('\n')
    ...
    out3_1.write('\n')
    out3_1.write('CHGs in repeats: ' + str(round(CHG_100_repeat, 2)) + ' %\n')
    out3_1.write('highly unmethylated CHGs in repeats: ' + str(round(CHG_100_unmet_repeat, 2)) + ' %\n')
    out3_1.write('rather unmethylated CHGs in repeats: ' + str(round(CHG_100_rather_unmet_repeat, 2)) + ' %\n')
    out3_1.write('50/50-methylated CHGs in repeats: ' + str(round(CHG_100_50met_repeat, 2)) + ' %\n')
    out3_1.write('rather methylated CHGs in repeats: ' + str(round(CHG_100_rather_met_repeat, 2)) + ' %\n')
    out3_1.write('highly methylated CHGs in repeats: ' + str(round(CHG_100_met_repeat, 2)) + ' %\n')
    out3_1.write('\n')
    out3_1.write('CHGs in upstream: ' + str(round(CHG_100_upstream, 2)) + ' %\n')
    out3_1.write('highly unmethylated CHGs in upstream: ' + str(round(CHG_100_unmet_upstream, 2)) + ' %\n')
    out3_1.write('rather unmethylated CHGs in upstream: ' + str(round(CHG_100_rather_unmet_upstream, 2)) + ' %\n')
    out3_1.write('50/50-methylated CHGs in upstream: ' + str(round(CHG_100_50met_upstream, 2)) + ' %\n')
    out3_1.write('rather methylated CHGs in upstream: ' + str(round(CHG_100_rather_met_upstream, 2)) + ' %\n')
    out3_1.write('highly methylated CHGs in upstream: ' + str(round(CHG_100_met_upstream, 2)) + ' %\n')
    out3_1.write('\n')
    out3_1.write('CHGs in downstream: ' + str(round(CHG_100_downstream, 2)) + ' %\n')
    out3_1.write('highly unmethylated CHGs in downstream: ' + str(round(CHG_100_unmet_downstream, 2)) + ' %\n')
    out3_1.write('rather unmethylated CHGs in downstream: ' + str(round(CHG_100_rather_unmet_downstream, 2)) + ' %\n')
    out3_1.write('50/50-methylated CHGs in downstream: ' + str(round(CHG_100_50met_downstream, 2)) + ' %\n')
    out3_1.write('rather methylated CHGs in downstream: ' + str(round(CHG_100_rather_met_downstream, 2)) + ' %\n')
    out3_1.write('highly methylated CHGs in downstream: ' + str(round(CHG_100_met_downstream, 2)) + ' %\n')
    out3_1.write('\n')
    out3_1.write('CHGs in non repeat regions: ' + str(round(CHG_100_non_repeat, 2)) + ' %\n')
    out3_1.write('highly unmethylated CHGs in non repeat regions: ' + str(round(CHG_100_unmet_non_repeat, 2)) + ' %\n')
    out3_1.write('rather unmethylated CHGs in non repeat regions: ' + str(round(CHG_100_rather_unmet_non_repeat, 2)) + ' %\n')
    out3_1.write('50/50-methylated CHGs in non repeat regions: ' + str(round(CHG_100_50met_non_repeat, 2)) + ' %\n')
    out3_1.write('rather methylated CHGs in non repeat regions: ' + str(round(CHG_100_rather_met_non_repeat, 2)) + ' %\n')
    out3_1.write('highly methylated CHGs in non repeat regions: ' + str(round(CHG_100_met_non_repeat, 2)) + ' %\n')
    out3_1.write('\n')
    ...
    out3_1.write('\n')
    out3_1.write('CHHs in repeats: ' + str(round(CHH_100_repeat, 2)) + ' %\n')
    out3_1.write('highly unmethylated CHHs in repeats: ' + str(round(CHH_100_unmet_repeat, 2)) + ' %\n')
    out3_1.write('rather unmethylated CHHs in repeats: ' + str(round(CHH_100_rather_unmet_repeat, 2)) + ' %\n')
    out3_1.write('50/50-methylated CHHs in repeats: ' + str(round(CHH_100_50met_repeat, 2)) + ' %\n')
    out3_1.write('rather methylated CHHs in repeats: ' + str(round(CHH_100_rather_met_repeat, 2)) + ' %\n')
    out3_1.write('highly methylated CHHs in repeats: ' + str(round(CHH_100_met_repeat, 2)) + ' %\n')
    out3_1.write('\n')
    out3_1.write('CHHs in upstream: ' + str(round(CHH_100_upstream, 2)) + ' %\n')
    out3_1.write('highly unmethylated CHHs in upstream: ' + str(round(CHH_100_unmet_upstream, 2)) + ' %\n')
    out3_1.write('rather unmethylated CHHs in upstream: ' + str(round(CHH_100_rather_unmet_upstream, 2)) + ' %\n')
    out3_1.write('50/50-methylated CHHs in upstream: ' + str(round(CHH_100_50met_upstream, 2)) + ' %\n')
    out3_1.write('rather methylated CHHs in upstream: ' + str(round(CHH_100_rather_met_upstream, 2)) + ' %\n')
    out3_1.write('highly methylated CHHs in upstream: ' + str(round(CHH_100_met_upstream, 2)) + ' %\n')
    out3_1.write('\n')
    out3_1.write('CHHs in downstream: ' + str(round(CHH_100_downstream, 2)) + ' %\n')
    out3_1.write('highly unmethylated CHHs in downstream: ' + str(round(CHH_100_unmet_downstream, 2)) + ' %\n')
    out3_1.write('rather unmethylated CHHs in downstream: ' + str(round(CHH_100_rather_unmet_downstream, 2)) + ' %\n')
    out3_1.write('50/50-methylated CHHs in downstream: ' + str(round(CHH_100_50met_downstream, 2)) + ' %\n')
    out3_1.write('rather methylated CHHs in downstream: ' + str(round(CHH_100_rather_met_downstream, 2)) + ' %\n')
    out3_1.write('highly methylated CHHs in downstream: ' + str(round(CHH_100_met_downstream, 2)) + ' %\n')
    out3_1.write('\n')
    out3_1.write('CHHs in non repeat regions: ' + str(round(CHH_100_non_repeat, 2)) + ' %\n')
    out3_1.write('highly unmethylated CHHs in non repeat regions: ' + str(round(CHH_100_unmet_non_repeat, 2)) + ' %\n')
    out3_1.write('rather unmethylated CHHs in non repeat regions: ' + str(round(CHH_100_rather_unmet_non_repeat, 2)) + ' %\n')
    out3_1.write('50/50-methylated CHHs in non repeat regions: ' + str(round(CHH_100_50met_non_repeat, 2)) + ' %\n')
    out3_1.write('rather methylated CHHs in non repeat regions: ' + str(round(CHH_100_rather_met_non_repeat, 2)) + ' %\n')
    out3_1.write('highly methylated CHHs in non repeat regions: ' + str(round(CHH_100_met_non_repeat, 2)) + ' %\n')
    out3_1.write('\n')
    
with open(fileLOG_3_2, "w") as out3_2:

    out3_2.write('[number_highly_unmethylated, %_highly_unmethylated, ..., number_highly_methylated, %_highly_methylated] in repeat, 1 kb upstream, 1 kb downstream and non_repeat regions\n')

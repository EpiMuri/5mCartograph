...
def get_data_of_interest(lines):
    ...
    for idx, line in enumerate(lines):
        ...
        elif line.startswith('unmethylated cytosines in repeats: ', 0):
        ...
        elif line.startswith('methylated cytosines in repeats: ', 0):
            values[4] = float(line.split(' ')[-2])
        # CG
        elif line.startswith('CGs in repeats: ', 0):
            CG_p = float(line.split(' ')[-2])
        elif line.startswith('unmethylated CGs in repeats: ', 0):
        ...
        elif line.startswith('methylated CGs in repeats: ', 0):
            values[9] = float(line.split(' ')[-2])
        # CHG
        elif line.startswith('CHGs in repeats: ', 0):
            CHG_p = float(line.split(' ')[-2])
        elif line.startswith('unmethylated CHGs in repeats: ', 0):
        ...
        elif line.startswith('methylated CHGs in repeats: ', 0):
            values[14] = float(line.split(' ')[-2])
        # CHH
        elif line.startswith('CHHs in repeats: ', 0):
            CHH_p = float(line.split(' ')[-2])
        elif line.startswith('unmethylated CHHs in repeats: ', 0):
        ...
        elif line.startswith('methylated CHHs in repeats: ', 0):
